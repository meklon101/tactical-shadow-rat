...
The victim client is designed to run as a Trojan-style executable concealed with an `image.jpg` cover image. When launched, the image appears in Windows Photo Viewer while the RAT code runs in the background.
